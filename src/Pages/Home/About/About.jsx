...
const About = () => {
  return (
    <div className="hero bg-white min-h-screen my-32">
      <div className="hero-content grid lg:grid-cols-2 grid-cols-1 lg:gap-x-14 justify-items-center items-center">
        ...
        <div >
        <h4 className='lg:text-2xl md:text-xl text-md text-red-500 font-bold mb-3'>About Us</h4>
          <h1 className="lg:text-5xl md:text-3xl text-lg font-bold">We are qualified & of experience in this field</h1>
          <p className="py-6">
